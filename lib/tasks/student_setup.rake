...
=begin 
  PARSE STUDENT LATEST.. nim only uniq to the school 
=end


task :parse_student_by_nim => :environment do
  FailedRegistration.all.each {|x| x.destroy }
